...
export type TSetMainActionPayload = Partial<
  Pick<IManifestInfo, "name" | "id" | "version">
>;
...
export type TSetSnippetActionPayload = Partial<
  Pick<ISnippet, "label" | "code" | "version" | "author">
>;
...
export type TSetPanelActionPayload = Partial<
  Pick<IEntrypointPanel, "id" | "label">
>;
...
export type TSetCommandActionPayload = Partial<
  Pick<IEntrypointCommand, "id" | "label" | "$$$snippetUUID">
>;
...
export function setSelectAction(
  type: "panel" | "command" | "snippet" | "general",
...
export function setPanelAction(
  arg: TSetPanelActionPayload,
  uuid: string,
): ISetPanelAction {
  return {
    type: "[SOR] SET_PANEL",
...
export function setSnippetAction(
  arg: TSetSnippetActionPayload,
  uuid: string,
): ISetSnippetAction {
  return {
    type: "[SOR] SET_SNIPPET",
...
export function assignSnippetToPanelAction(
  operation: "on" | "off",
  uuid: string,
  snippetUuid: string,
): IAssignSnippetToPanelAction {
  return {
    type: "[SOR] ASSIGN_SNIPPET_TO_PANEL",
    payload: {
      operation,
