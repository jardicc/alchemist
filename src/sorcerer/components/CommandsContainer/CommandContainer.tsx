      ...
      <div className="CommandContainerContainer" key="commandPanel">
        ...
        <div className="row">
          ...
          <SP.Textfield
            ...
            onInput={(e) =>
              onSet(activeCommand.$$$uuid, { id: e.target?.value })
            }
          />
        </div>
        <div className="row">
            ...
            >
              {snippets.map((item) => (
                <SP.MenuItem
                  ...
                  value={item.$$$uuid}
                  selected={
                    activeCommand.$$$snippetUUID === item.$$$uuid
                      ? true
                      : undefined
                  }
                >
