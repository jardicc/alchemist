...
export class RawDataConverter {
  ...
  public static replaceArrayBuffer(
    obj: ActionDescriptor[] | ActionDescriptor,
        ...
        if (Object.prototype.hasOwnProperty.call(data, key)) {
          if (Array.isArray(data)) {
            ...
            if (settings.makeRawDataEasyToInspect) {
              ...
              data[key] =
                "<ArrayBuffer> This value was ignored for performance reasons. Turn this on in Alchemist > Settings > Support raw data type";
            }
  ...
  public static convertFakeRawInCode(
    obj: ActionDescriptor,
    descSettings: IDescriptorSettings,
  ): void {
    rec(obj);
      ...
      for (const key in data) {
        if (Object.prototype.hasOwnProperty.call(data, key)) {
          ...
          if (Array.isArray(itemInData)) {
            ...
            itemInData instanceof ArrayBuffer &&
            descSettings.supportRawDataType === true
          ) {
            ...
            if (
              "_rawData" in itemInData &&
              itemInData._rawData === "alchemistFakeType"
            ) {
