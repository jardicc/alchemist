...
export class GetList {
  ...
  public static getChannels(
    ...
    const pairs: IFilterProperty<TChannelReference>[] =
      docE.userChannelIDsAndNames.map((p) => ({
        value: p.value,
        label: p.label,
      })); // remove index
    return pairs;
  ...
  public static getPaths(
    ...
    const pairs: IFilterProperty<TPathReference>[] =
      docE.userPathsIDsAndNames.map((p) => ({
        value: p.value,
        label: p.label,
      }));
    return pairs;
  ...
  public static getGuides(
    ...
    const pairs: IFilterProperty<TGuideReference>[] = docE.guidesIDs.map(
      (p) => ({
        value: p.value,
        label: p.label,
      }),
  ...
  public static getHistory(): IFilterProperty<THistoryReference>[] {
    ...
    const result: IFilterProperty<THistoryReference>[] = pairs
      .filter((p) => !p.snapshot)
      .map((p) => ({
        value: p.value,
        label: p.label,
  ...
  public static getActionSets(): IFilterProperty<TActionSet>[] {
    const actionSets: IFilterProperty<TActionSet>[] = app.actionTree.map(
      (item) => ({
        value: item.id,
        label: item.name,
      }),
  ...
  public static getActionItem(
    ...
    const action: IFilterProperty<TActionItem>[] = actionSet.actions.map(
      (item) => ({
        value: item.id,
        label: item.name,
      }),
  ...
  public static getActionCommands(
    actionItemID: number,
  ...
  public static getAllCommandsOfAction(
    actionItemID: number,
  ): ActionDescriptor[] {
  ...
  private static getDocumentExtra(
    docID: number | "selected",
  ): DocumentExtra | null {
    let res: number;
    if (docID === "selected") {
