...
export type TReferenceNonProp =
  | INameReference<TClasses>
  | IDReference<TClasses>
  | IEnumReference<TClasses>
  | IndexReference<TClasses>;
...
export class Reference {
  ...
  public get propertiesOnly(): IPropertyReference[] {
    const res = this.ref.filter(
      (v) => "_property" in v,
    ) as IPropertyReference[];
    return res;
  }

  public get refsOnly(): TReferenceNonProp[] {
    const res = this.ref.filter(
      (v) => "_ref" in v && !("_property" in v),
    ) as TReferenceNonProp[];
    return res;
  }
  ...
  public get property(): IPropertyReference | null {
    return (
      (this.ref.find((i) => "_property" in i) as IPropertyReference) || null
    );
  }
  ...
  public get action(): IDReference<"action"> | null {
    return (
      (this.ref.find(
        (i) => "_ref" in i && i._ref === "action",
      ) as IDReference<"action">) || null
    );
  }
  ...
  public get actionSet(): IDReference<"actionSet"> | null {
    return (
      (this.ref.find(
        (i) => "_ref" in i && i._ref === "actionSet",
      ) as IDReference<"actionSet">) || null
    );
  }
  ...
  public get application(): IApplicationReference | null {
    return (
      (this.ref.find(
        (i) => "_ref" in i && i._ref === "application",
      ) as IApplicationReference) || null
    );
  }

  public get channel():
    | IDReference<"channel">
    | IEnumReference<"channel">
    | null {
    return (
      (this.ref.find((i) => "_ref" in i && i._ref === "channel") as
        | IDReference<"channel">
        | IEnumReference<"channel">) || null
    );
  }
  ...
  public get command(): INameReference<"command"> | null {
    return (
      (this.ref.find(
        (i) => "_ref" in i && i._ref === "command",
      ) as INameReference<"command">) || null
    );
  }
  ...
  public get document(): IDReference<"document"> | null {
    return (
      (this.ref.find(
        (i) => "_ref" in i && i._ref === "document",
      ) as IDReference<"document">) || null
    );
  }
  ...
  public get guide(): IDReference<"guide"> | null {
    return (
      (this.ref.find(
        (i) => "_ref" in i && i._ref === "guide",
      ) as IDReference<"guide">) || null
    );
  }
  ...
  public get historyState(): IDReference<"historyState"> | null {
    return (
      (this.ref.find(
        (i) => "_ref" in i && i._ref === "historyState",
      ) as IDReference<"historyState">) || null
    );
  }
  ...
  public get layer(): IDReference<"layer"> | null {
    return (
      (this.ref.find(
        (i) => "_ref" in i && i._ref === "layer",
      ) as IDReference<"layer">) || null
    );
  }
  ...
  public get path(): IDReference<"path"> | null {
    return (
      (this.ref.find(
        (i) => "_ref" in i && i._ref === "path",
      ) as IDReference<"path">) || null
    );
  }
  ...
  public get snapshotClass(): IDReference<"snapshotClass"> | null {
    return (
      (this.ref.find(
        (i) => "_ref" in i && i._ref === "snapshotClass",
      ) as IDReference<"snapshotClass">) || null
    );
  }
  ...
  private removeAllClasses(myClass: TClasses) {
    this.ref = this.ref.filter(
      (r) => ("_ref" in r && r._ref === myClass) === false,
    );
  }
}
