...
export function getInitialState(): IInspectorState {
  return {
    ...
    dispatcher: {
      snippets: [
        {
          content: `const batchPlay = require("photoshop").action.batchPlay;\n\nreturn await batchPlay([{"_obj": "invert"}],{});`,
        },
      ],
    },
      ...
      properties: [
          ...
          list: [
            { label: "(not specified)", value: "notSpecified" },
            {
              ...
              data: [
                ...
                {
                  label: "highlightColorOption",
                  value: "highlightColorOption",
                },
                {
                  label: "historyLogPreferences",
                  value: "historyLogPreferences",
                },
                { label: "historyPreferences", value: "historyPreferences" },
                { label: "homeScreenReady", value: "homeScreenReady" },
                {
                  label: "homeScreenVisibility",
                  value: "homeScreenVisibility",
                },
                { label: "hostName", value: "hostName" },
                { label: "hostVersion", value: "hostVersion" },
                {
                  label: "imageProcessingPrefs",
                  value: "imageProcessingPrefs",
                },
                {
                  label: "interfaceBevelHighlight",
                  value: "interfaceBevelHighlight",
                },
                {
                  label: "interfaceBevelShadow",
                  value: "interfaceBevelShadow",
                },
                { label: "interfaceBlack", value: "interfaceBlack" },
                { label: "interfaceBorder", value: "interfaceBorder" },
                {
                  label: "interfaceButtonDarkShadow",
                  value: "interfaceButtonDarkShadow",
                },
                {
                  label: "interfaceButtonDownFill",
                  value: "interfaceButtonDownFill",
                },
                {
                  label: "interfaceButtonShadow",
                  value: "interfaceButtonShadow",
                },
                { label: "interfaceButtonText", value: "interfaceButtonText" },
                {
                  label: "interfaceButtonUpFill",
                  value: "interfaceButtonUpFill",
                },
                {
                  label: "interfaceCanvasColor",
                  value: "interfaceCanvasColor",
                },
                {
                  label: "interfaceIconFillActive",
                  value: "interfaceIconFillActive",
                },
                {
                  label: "interfaceIconFillDimmed",
                  value: "interfaceIconFillDimmed",
                },
                {
                  label: "interfaceIconFillSelected",
                  value: "interfaceIconFillSelected",
                },
                {
                  label: "interfaceIconFrameActive",
                  value: "interfaceIconFrameActive",
                },
                {
                  label: "interfaceIconFrameDimmed",
                  value: "interfaceIconFrameDimmed",
                },
                {
                  label: "interfaceIconFrameSelected",
                  value: "interfaceIconFrameSelected",
                },
                {
                  label: "interfaceOWLPaletteFill",
                  value: "interfaceOWLPaletteFill",
                },
                {
                  label: "interfacePaletteFill",
                  value: "interfacePaletteFill",
                },
                ...
                {
                  label: "interfaceToolTipBackground",
                  value: "interfaceToolTipBackground",
                },
                {
                  label: "interfaceToolTipText",
                  value: "interfaceToolTipText",
                },
                {
                  label: "interfaceTransparencyBackground",
                  value: "interfaceTransparencyBackground",
                },
                {
                  label: "interfaceTransparencyForeground",
                  value: "interfaceTransparencyForeground",
                },
                ...
                {
                  label: "layerVisibilityChangesAreUndoable",
                  value: "layerVisibilityChangesAreUndoable",
                },
                ...
                {
                  label: "recentFilesAsStrings",
                  value: "recentFilesAsStrings",
                },
                { label: "regionCode", value: "regionCode" },
                { label: "rulerUnits", value: "rulerUnits" },
                {
                  label: "scratchDiskPreferences",
                  value: "scratchDiskPreferences",
                },
                ...
                {
                  label: "toolSupportsBrushPresets",
                  value: "toolSupportsBrushPresets",
                },
                {
                  label: "transparencyGamutPreferences",
                  value: "transparencyGamutPreferences",
                },
                ...
                {
                  label: "useCacheForHistograms",
                  value: "useCacheForHistograms",
                },
            ...
            },
            {
              ...
              data: [
                ...
                {
                  label: "canvasBackgroundColors",
                  value: "canvasBackgroundColors",
                },
                ...
                {
                  label: "pixelScaleFactorList",
                  value: "pixelScaleFactorList",
                },
                { label: "recentFileEntries", value: "recentFileEntries" },
                {
                  label: "recentlyUsedCCLibrariesTemplateElements",
                  value: "recentlyUsedCCLibrariesTemplateElements",
                },
                { label: "springLoadedTools", value: "springLoadedTools" },
                {
                  label: "springLoadedToolsTimingSensitivity",
                  value: "springLoadedToolsTimingSensitivity",
                },
              ],
            },
            {
              ...
              data: [
                { label: "$bhn2", value: "$bhn2" },
                { label: "$bhnc", value: "$bhnc" },
                { label: "$wlcm", value: "$wlcm" },
                { label: "customPreference", value: "customPreference" },
                {
                  label: "designSpaceLibrariesInfo",
                  value: "designSpaceLibrariesInfo",
                },
          ...
          list: [
            ...
            },
            {
              ...
              data: [
                ...
                {
                  label: "layerSectionExpanded",
                  value: "layerSectionExpanded",
                },
            ...
            },
            {
              ...
              data: [
                ...
                {
                  label: "layerPathComponentCount",
                  value: "layerPathComponentCount",
                },
                { label: "layerSVGdata", value: "layerSVGdata" },
                {
                  label: "layerVectorPointData",
                  value: "layerVectorPointData",
                },
                { label: "metadata", value: "metadata" },
                { label: "pathBounds", value: "pathBounds" },
                {
                  label: "preserveTransparency",
                  value: "preserveTransparency",
                },
          ...
          list: [
            { label: "(not specified)", value: "notSpecified" },
            {
              ...
              data: [
                ...
                { label: "duotoneInk", value: "duotoneInk" },
                ...
                {
                  label: "smartGuidesVisibility",
                  value: "smartGuidesVisibility",
                },
                ...
                {
                  label: "targetPathsVisibility",
                  value: "targetPathsVisibility",
                },
                {
                  label: "targetPathVisibility",
                  value: "targetPathVisibility",
                },
        ...
        },
        {
          ...
          list: [
            ...
            {
              label: "documentTimelineSettings",
              value: "documentTimelineSettings",
            },
