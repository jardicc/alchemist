...
class ItemVisibilityButton extends React.Component<
  TItemVisibilityButton,
...
> {
  ...
  public render(): JSX.Element {
    return (
      <div
        className={
          "ItemVisibilityButton " + (this.visible ? "visible" : "hidden")
        }
        onClick={(e) => {
          e.stopPropagation();
          this.toggle();
...
type TItemVisibilityButton = IItemVisibilityButtonProps &
  IItemVisibilityButtonDispatch;
...
const mapDispatchToProps: MapDispatchToPropsNonObject<
  IItemVisibilityButtonDispatch,
  IOwnProps
> = (dispatch): IItemVisibilityButtonDispatch => ({
  onChangeVisibility: (item, operation) =>
    dispatch(setCategoryItemVisibilityAction(item, operation)),
});

const ItemVisibilityButtonContainer = connect(
  mapStateToProps,
  mapDispatchToProps,
...
export class ItemVisibilityButtonWrap extends React.Component<IAccDropPostFixProps> {
  ...
  render(): React.ReactNode {
    return (
      <ItemVisibilityButtonContainer
        value={this.props.value as TTargetReference}
      />
    );
  }
}
