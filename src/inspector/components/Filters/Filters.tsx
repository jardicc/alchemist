...
export class Filters extends React.Component<TFilters, IState> {
  ...
  private MainCategory = (): JSX.Element => {
    ...
    return (
      <FilterRowContainer
        ...
        onSelect={(value) =>
          this.props.onSetSelectedReferenceType(value as TTargetReference)
        }
      />
    );
  };
      ...
      case "path": {
        return (
          <FilterRowContainer
            ...
            onSelect={(value) => {
              onSetTargetReference({
                documentID: value as number | "selected",
              });
            }}
  ...
  private Layer = (): JSX.Element | null => {
    ...
    if (
      activeRef.type === "channel" &&
      activeRef.channelID !== "mask" &&
      activeRef.channelID !== "filterMask"
    ) {
      return null;
    }
    ...
    return (
      <FilterRowContainer
        ...
        onUpdateList={() => GetList.getLayers(activeRef.documentID)}
      />
    );
  };
  ...
  private Channel = (): JSX.Element | null => {
    ...
    return (
      <FilterRowContainer
        ...
        onUpdateList={() => GetList.getChannels(activeRef.documentID)}
      />
    );
  };
  ...
  private Path = (): JSX.Element | null => {
    ...
    return (
      <FilterRowContainer
        ...
        onUpdateList={() => GetList.getPaths(activeRef.documentID)}
      />
    );
  };
  ...
  private ActionSet = (): JSX.Element | null => {
    ...
    return (
      <FilterRowContainer
        ...
        onUpdateList={() => GetList.getActionSets()}
      />
    );
  };
  ...
  private ActionItem = (): JSX.Element | null => {
    ...
    return (
      <FilterRowContainer
        ...
        onUpdateList={() => GetList.getActionItem(id)}
      />
    );
  };
  ...
  private Command = (): JSX.Element | null => {
    ...
    return (
      <FilterRowContainer
        ...
        onUpdateList={() => GetList.getActionCommands(id)}
      />
    );
  };
  ...
  private Guide = (): JSX.Element | null => {
    ...
    return (
      <FilterRowContainer
        ...
        onUpdateList={() => GetList.getGuides(activeRef.documentID)}
      />
    );
  };
  ...
  private History = (): JSX.Element | null => {
    const { activeRef, onSetTargetReference } = this.props;
    if (activeRef.type !== "historyState") {
      return null;
    }
    ...
    return (
      <FilterRowContainer
        ...
        onUpdateList={() => GetList.getHistory()}
      />
    );
  };
  ...
  private Snapshots = (): JSX.Element | null => {
    const { activeRef, onSetTargetReference } = this.props;
    if (activeRef.type !== "snapshotClass") {
      return null;
    }
    ...
    return (
      <FilterRowContainer
        ...
        onUpdateList={() => GetList.getSnapshots()}
      />
    );
  };
...
> = (dispatch: Dispatch): IFiltersDispatch => ({
  onSetSelectedReferenceType: (type) =>
    dispatch(setSelectedReferenceTypeAction(type)),
