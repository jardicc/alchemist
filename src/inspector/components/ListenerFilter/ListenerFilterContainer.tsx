...
class ListenerFilter extends React.Component<
  TListenerFilter,
      ...
      case "exclude": {
        return (
          <>
            ...
            <SP.Textfield
              onInput={this.setExclude as any}
              value={exclude.join(";")}
              className="input"
              quiet
            />
      ...
      case "include": {
        return (
          <>
            ...
            <SP.Textfield
              onInput={this.setInclude as any}
              value={include.join(";")}
              className="input"
              quiet
            />
  ...
  public render(): JSX.Element {
    ...
    return (
      <>
        ...
        <div className="excludeIncludeInput">{this.renderFilterFields()}</div>
      </>
    );
  }
}
...
const mapDispatchToProps: MapDispatchToPropsFunction<
  IListenerFilterDispatch,
  Record<string, unknown>
> = (dispatch): IListenerFilterDispatch => ({
  onSetNotifierListenerFilter: (arg) =>
    dispatch(setListenerNotifierFilterAction(arg)),
});

export const ListenerFilterContainer = connect(
  mapStateToProps,
  mapDispatchToProps,
)(ListenerFilter);
