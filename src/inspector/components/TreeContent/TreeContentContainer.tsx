...
import {
  getTreeContent,
  getContentPath,
  getContentExpandedNodes,
  getActiveDescriptorContent,
  getContentActiveView,
  getContentExpandLevel,
  getSearchContentKeyword,
} from "../../selectors/inspectorContentSelectors";
...
class TreeContent extends Component<TTreeContent, Record<string, unknown>> {
  ...
  private labelRenderer: TLabelRenderer = (
    [key, ...rest],
    nodeType,
    expanded,
    expandable,
  ...
  public render(): React.ReactNode {
    ...
    return (
      <TabList
        ...
        activeKey={viewType}
        onChange={onSetView}
        postFix={this.renderSearchField()}
      >
            ...
            <div className="TreeContentBox">
              {content === undefined || content === null ? (
                <div className="message">
                  Content is missing. Please make sure that your selected
                  descriptor and your pinned property exists
                </div>
              ) : (
                <JSONTree
...
const mapDispatchToProps: MapDispatchToPropsFunction<
  ITreeContentDispatch,
  Record<string, unknown>
> = (dispatch): ITreeContentDispatch => ({
  onInspectPath: (path, mode) =>
    dispatch(setInspectorPathContentAction(path, mode)),
  onSetExpandedPath: (path, expand, recursive, data) =>
    dispatch(setExpandedPathAction("content", path, expand, recursive, data)),
  onSetView: (viewType) =>
    dispatch(setInspectorViewAction("content", viewType)),
  onSetAutoExpandLevel: (level) =>
    dispatch(setAutoExpandLevelAction("content", level)),
