...
import {IContent, IDOM, IDifference, IInspectorState, TCodeViewType, TGenericViewType, TPath, TSubTypes} from "../model/types";
...
export const inspectorReducer = (state: IInspectorState, action: TInspectorActions): IInspectorState => {
	switch (action.type) {
		case "SET_MODE_TAB": {
