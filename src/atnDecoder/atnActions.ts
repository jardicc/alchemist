...
export function setDontSendDisabledAction(
  value: boolean,
): ISetDontSendDisabledAction {
  return {
    type: "[ATN] SET_DONT_SEND_DISABLED",
    payload: value,
  };
...
export function setSelectActionAction(
  operation: TSelectActionOperation,
  uuid?: TSelectedItem,
): ISelectAction {
  return {
...
export function setExpandActionAction(
  uuid: TExpandedItem,
  expand: boolean,
  recursive = false,
): IExpandAction {
