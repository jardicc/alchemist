...
describe("parse", () => {
  it("can decode empty set", () => {
    const buf = new Uint8Array(
      Buffer.from("00000010000000040066006f006f00000100000000", "hex"),
    ).buffer;
  ...
  it("can decode empty actions", () => {
    const buf = new Uint8Array(
      Buffer.from(
        "00000010000000040066006f006f000001000000020000000000000000000500620061007200310000010000000000030101000200000005006200610072003200000100000000",
        "hex",
      ),
    ).buffer;
    const data = new DataViewCustom(buf, false);
  ...
  it("can decode invert action", () => {
    const buf = new Uint8Array(
      Buffer.from(
        "00000010000000040066006f006f0000010000000100000000000000000005006200610072003100000100000001000100025445585400000006696e7665727400000006496e7665727400000000",
        "hex",
      ),
    ).buffer;
    const data = new DataViewCustom(buf, false);
...
it("can decode gaussian blur action", () => {
  const buf = new Uint8Array(
    Buffer.from(
      "",
      "hex",
    ),
  ).buffer;
  const data = new DataViewCustom(buf, false);
...
describe("parseDescriptor", () => {
  it("can decode simple ActionDescriptor with string", () => {
    const buf = s2b(
      "%00%00%00%10%00%00%00%01%00%00%00%00%00%00null%00%00%00%01%00%00%00%03fooTEXT%00%00%00%04%00b%00a%00r%00%00",
    );
    const data = new DataViewCustom(buf, false);
    const out = {};
  ...
  it("can decode lowest int", () => {
    const buf = s2b(
      "%00%00%00%10%00%00%00%01%00%00%00%00%00%00null%00%00%00%01%00%00%00%03foolong%C2%80%00%00%00",
    );
  ...
  it("can decode int 1000", () => {
    const buf = s2b(
      "%00%00%00%10%00%00%00%01%00%00%00%00%00%00null%00%00%00%01%00%00%00%03foolong%00%00%03%C3%A8",
    );
    const data = new DataViewCustom(buf, false);
    const out = {};
  ...
  it("can decode boolean true", () => {
    const buf = s2b(
      "%00%00%00%10%00%00%00%01%00%00%00%00%00%00null%00%00%00%01%00%00%00%03foobool%01",
    );
    const data = new DataViewCustom(buf, false);
    const out = {};
  ...
  it("can decode class", () => {
    const buf = s2b(
      "%00%00%00%10%00%00%00%01%00%00%00%00%00%00null%00%00%00%01%00%00%00%03footype%00%00%00%01%00%00%00%00%00%03bar",
    );
    const data = new DataViewCustom(buf, false);
    const out = {};
  ...
  it("can decode double", () => {
    const buf = s2b(
      "%00%00%00%10%00%00%00%01%00%00%00%00%00%00null%00%00%00%01%00%00%00%03foodoub%C3%80E5%C3%82%C2%8F%5C(%C3%B6",
    );
    const data = new DataViewCustom(buf, false);
    const out = {};
  ...
  it("can decode unit double", () => {
    const buf = s2b(
      "%00%00%00%10%00%00%00%01%00%00%00%00%00%00null%00%00%00%01%00%00%00%03fooUntF#Prc%C3%80E5%C3%82%C2%8F%5C(%C3%B6",
    );
    const data = new DataViewCustom(buf, false);
    const out = {};
  ...
  it("can decode enum", () => {
    const buf = s2b(
      "%00%00%00%10%00%00%00%01%00%00%00%00%00%00null%00%00%00%01%00%00%00%00Fl%20%20enum%00%00%00%00Fl%20%20%00%00%00%00Wht%20",
    );
    const data = new DataViewCustom(buf, false);
    const out = {};
  ...
  it("can decode descriptor in descriptor", () => {
    const buf = s2b(
      "%00%00%00%10%00%00%00%01%00%00%00%00%00%00null%00%00%00%01%00%00%00%03fooObjc%00%00%00%01%00%00%00%00%00%03bar%00%00%00%00",
    );
    const data = new DataViewCustom(buf, false);
    const out = {};
  ...
  it("can decode list of integers and boolean", () => {
    const buf = s2b(
      "%00%00%00%10%00%00%00%01%00%00%00%00%00%00null%00%00%00%01%00%00%00%03fooVlLs%00%00%00%03long%00%00%00%0Along%00%00%00%14bool%00",
    );
    const data = new DataViewCustom(buf, false);
    const out = {};
  ...
  it("can decode path", () => {
    const buf = s2b(
      "%00%00%00%10%00%00%00%01%00%00%00%00%00%00null%00%00%00%01%00%00%00%07examplePth%20%00%00%00(txtu(%00%00%00%0E%00%00%00C%00:%00%5C%00f%00o%00o%00%5C%00b%00a%00r%00.%00h%00i%00%00%00",
    );
    const data = new DataViewCustom(buf, false);
    const out = {};
  ...
  it("can decode raw data", () => {
    const buf = s2b(
      "%00%00%00%10%00%00%00%01%00%00%00%00%00%00null%00%00%00%01%00%00%00%03footdta%00%00%00%06%00%00%00%10%C3%BF%C3%BF",
    );
    const data = new DataViewCustom(buf, false);
    const out = {};
  ...
  it("can decode reference with index", () => {
    const buf = s2b(
      "%00%00%00%10%00%00%00%01%00%00%00%00%00%00null%00%00%00%01%00%00%00%03fooobj%20%00%00%00%01indx%00%00%00%01%00%00%00%00%00%03bar%00%00%00*",
    );
    const data = new DataViewCustom(buf, false);
    const out = {};
  ...
  it("can decode reference with identifier", () => {
    const buf = s2b(
      "%00%00%00%10%00%00%00%01%00%00%00%00%00%00null%00%00%00%01%00%00%00%03fooobj%20%00%00%00%01Idnt%00%00%00%01%00%00%00%00%00%00Dcmn%00%00%00%16",
    );
    const data = new DataViewCustom(buf, false);
    const out = {};
  ...
  it("can decode reference with offset", () => {
    const buf = s2b(
      "%00%00%00%10%00%00%00%01%00%00%00%00%00%00null%00%00%00%01%00%00%00%03fooobj%20%00%00%00%01rele%00%00%00%01%00%00%00%00%00%00Dcmn%00%00%00%0C",
    );
    const data = new DataViewCustom(buf, false);
    const out = {};
  ...
  it("can decode reference with name", () => {
    const buf = s2b(
      "%00%00%00%10%00%00%00%01%00%00%00%00%00%00null%00%00%00%01%00%00%00%03fooobj%20%00%00%00%01name%00%00%00%01%00%00%00%00%00%00Dcmn%00%00%00%04%00b%00a%01Y%00%00",
    );
    const data = new DataViewCustom(buf, false);
    const out = {};
  ...
  it("can decode reference with class", () => {
    const buf = s2b(
      "%00%00%00%10%00%00%00%01%00%00%00%00%00%00null%00%00%00%01%00%00%00%03fooobj%20%00%00%00%01Clss%00%00%00%01%00%00%00%00%00%00Dcmn",
    );
    const data = new DataViewCustom(buf, false);
    const out = {};
  ...
  it("can decode reference with enum", () => {
    const buf = s2b(
      "%00%00%00%10%00%00%00%01%00%00%00%00%00%00null%00%00%00%01%00%00%00%03fooobj%20%00%00%00%01Enmr%00%00%00%01%00%00%00%00%00%00Lyr%20%00%00%00%00Ordn%00%00%00%00Trgt",
    );
    const data = new DataViewCustom(buf, false);
    const out = {};
  ...
  it("can decode multiple reference indexes", () => {
    const buf = s2b(
      "%00%00%00%10%00%00%00%01%00%00%00%00%00%00null%00%00%00%01%00%00%00%03fooobj%20%00%00%00%03indx%00%00%00%01%00%00%00%00%00%03bar%00%00%00*indx%00%00%00%01%00%00%00%00%00%03bar%00%00%00+indx%00%00%00%01%00%00%00%00%00%03bar%00%00%00,",
    );
    const data = new DataViewCustom(buf, false);
    const out = {};
  ...
  it("can decode property with reference index", () => {
    const buf = s2b(
      "%00%00%00%10%00%00%00%01%00%00%00%00%00%00null%00%00%00%01%00%00%00%03fooobj%20%00%00%00%02prop%00%00%00%01%00%00%00%00%00%00Prpr%00%00%00%00Hghtindx%00%00%00%01%00%00%00%00%00%00Dcmn%00%00%00%16",
    );
    const data = new DataViewCustom(buf, false);
    const out = {};
  ...
  it("can decode lowest 52bit integer", () => {
    const buf = s2b(
      "%00%00%00%10%00%00%00%01%00%00%00%00%00%00null%00%00%00%01%00%00%00%03foocomp%C3%BF%C3%B0%00%00%00%00%00%00",
    );
    const data = new DataViewCustom(buf, false);
    const out = {};
  ...
  it("can decode path longer than 128 chars", () => {
    ...
    expect(out).toEqual({
      ...
      link: {
        _kind: "local",
        _path:
          "C:\\Users\\Jarda\\Desktop\\smazat\\opravduMocdlouháCestaKsouboru\\opravduMocdlouháCestaKsouboru\\opravduMocdlouháCestaKsouboru\\opravduMocdlouháCestaKsouboru\\opravduMocdlouháCestaKsouboru\\opravduMocdlouháCestaKsouboru.psb",
      },
    });
  });
  ...
  it("can decode path with extra null terminator", () => {
    ...
    expect(out).toEqual({
      ...
      fileReference: {
        _kind: "local",
        _path:
          "d:\\ClientDir\\2021-01-18\\DESKTOP-9IFSG90-Jarda\\Files\\1234\\6229732_v001_Supplied_OTL.png\\WorkingFiles\\6229732_v001_Supplied_OTL.tif",
      },
    });
  });
      ...
      to: {
        ...
        points: {
          ...
          horizontal: {
            _unit: "pixelsUnit",
            list: [
              659.4954128440367, 863.3394495412844, 1151.119266055046,
              659.4954128440367,
            ],
          },
          vertical: {
            _unit: "pixelsUnit",
            list: [822, 342, 786, 834],
          },
        },
      },
    });
