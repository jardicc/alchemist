...
describe("parse", () => {
	...
	it("can decode empty set", () => {
		const buf = new Uint8Array(Buffer.from("00000010000000040066006f006f00000100000000", "hex")).buffer;
	...
	it("can decode empty actions", () => {
		const buf = new Uint8Array(Buffer.from("00000010000000040066006f006f000001000000020000000000000000000500620061007200310000010000000000030101000200000005006200610072003200000100000000", "hex")).buffer;
		const data = new DataViewCustom(buf, false);
	...
	it("can decode invert action", () => {
		const buf = new Uint8Array(Buffer.from("00000010000000040066006f006f0000010000000100000000000000000005006200610072003100000100000001000100025445585400000006696e7665727400000006496e7665727400000000", "hex")).buffer;
		const data = new DataViewCustom(buf, false);
...
it("can decode gaussian blur action", () => {
	const buf = new Uint8Array(Buffer.from("", "hex")).buffer;
	const data = new DataViewCustom(buf, false);
